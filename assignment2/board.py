...
class GoBoard(object):
    ...
    def set_color(self, color, point):
    ...
    def detect_three_in_a_row(self):
        """
        Returns BLACK or WHITE if any three in a row is detected for the color
        EMPTY otherwise.
        """
        for r in self.rows:
    ...
    def has_three_in_list(self, list):
        """
        Returns BLACK or WHITE if any three in a rows exist in the list.
        EMPTY otherwise.
        """
        prev = BORDER
        counter = 1
